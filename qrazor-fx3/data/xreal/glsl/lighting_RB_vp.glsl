...
void	main()
{
	...
	var_tex_bump = (gl_TextureMatrix[1] * attr_TexCoord0).st;
	
	// transform texcoords_lm into lightmap texture space
	var_tex_light = (gl_TextureMatrix[2] * attr_TexCoord1).st;
	
	// transform texcoords_lm into deluxemap texture space
	var_tex_deluxe = (gl_TextureMatrix[3] * attr_TexCoord1).st;
