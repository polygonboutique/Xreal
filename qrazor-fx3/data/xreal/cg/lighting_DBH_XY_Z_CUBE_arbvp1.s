...
PARAM s259[4] = { state.matrix.mvp };
	...
	DP4 result.texcoord[3].x, s275[0], v0;
	DP4 result.texcoord[3].y, s275[1], v0;
	DP4 result.texcoord[3].z, s275[2], v0;
	DP4 result.texcoord[3].w, s275[3], v0;
	DP4 result.texcoord[4].x, s283[0], v0;
	DP4 result.texcoord[4].y, s283[1], v0;
	DP4 result.texcoord[4].z, s283[2], v0;
	DP4 result.texcoord[4].w, s283[3], v0;
END
# 30 instructions
# 1 temp registers
# End of program
