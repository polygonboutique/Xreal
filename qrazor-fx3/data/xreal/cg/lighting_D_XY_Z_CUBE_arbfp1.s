...
#var float3 light_origin :  : c[1] : 5 : 1
#var float3 light_color :  : c[0] : 6 : 1
...
#var float4 IN.tex_cube : $vin.TEXCOORD4 : TEX4 : 0 : 1
...
TEX R3.xyz, fragment.texcoord[4], texture[3], CUBE;
MOV R0.xyz, R1;
MUL R1.xyz, R0, R2;
MOV R0.xyz, R1;
MUL R1.xyz, R0, R3;
...
MOV result.color, R0;
END
# 24 instructions, 4 R-regs, 0 H-regs.
# End of program
