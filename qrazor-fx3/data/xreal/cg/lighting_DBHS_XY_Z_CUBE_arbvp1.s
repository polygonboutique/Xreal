...
PARAM s287[4] = { state.matrix.texture[6] };
...
PARAM s259[4] = { state.matrix.mvp };
	...
	DP4 R0.x, s271[0], v8;
	DP4 R0.y, s271[1], v8;
	MOV result.texcoord[2].xy, R0.xyxx;
	DP4 R0.x, s275[0], v8;
	DP4 R0.y, s275[1], v8;
	MOV result.texcoord[2].zw, R0.xyxy;
	DP4 result.texcoord[3].x, s279[0], v0;
	DP4 result.texcoord[3].y, s279[1], v0;
	DP4 result.texcoord[3].z, s279[2], v0;
	DP4 result.texcoord[3].w, s279[3], v0;
	DP4 result.texcoord[4].x, s287[0], v0;
	DP4 result.texcoord[4].y, s287[1], v0;
	DP4 result.texcoord[4].z, s287[2], v0;
	DP4 result.texcoord[4].w, s287[3], v0;
END
# 36 instructions
# 1 temp registers
# End of program
