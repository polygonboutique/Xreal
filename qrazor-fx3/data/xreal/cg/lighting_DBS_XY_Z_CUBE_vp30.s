...
#var float4x4 matrix_tcmod_specular :  : c[12], 4 : 4 : 1
#var float4x4 matrix_tcmod_attenuation_xy_z :  : c[16], 4 : 5 : 1
#var float4x4 matrix_tcmod_attenuation_cube :  : c[20], 4 : 6 : 1
...
b0:
	...
	DP4 o[TEX3].x, c[16], v[0];
	DP4 o[TEX3].y, c[17], v[0];
	DP4 o[TEX3].z, c[18], v[0];
	DP4 o[TEX3].w, c[19], v[0];
	DP4 o[TEX4].x, c[20], v[0];
	DP4 o[TEX4].y, c[21], v[0];
	DP4 o[TEX4].z, c[22], v[0];
	DP4 o[TEX4].w, c[23], v[0];
END
# 30 instructions
# 1 temp registers
# End of program
