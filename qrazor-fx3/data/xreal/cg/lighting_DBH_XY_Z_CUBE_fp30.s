...
#var float height_scale :  :  : 11 : 1
#var float height_bias :  :  : 12 : 1
...
RSQR R2.x, R2.x;
MULR R3.xy, R2.x, R3.xyzx;
MOVR R2.x, height_bias.x;
MADR R2.x, R0.x, height_scale.x, R2.x;
MADR R0.xy, R2.x, R3.xyxx, f[TEX1].zwzz;
MADR R3.xy, R2.x, R3.xyxx, f[TEX1].xyxx;
...
MULH H1.xyz, H1.xyzx, R0.xyzx;
MOVH H0.xyz, H1.xyzx;
MULH H1.xyz, H0.xyzx, R1.xyzx;
MOVH H0.xyz, H1.xyzx;
MOVH o[COLH], H0;
END
# 53 instructions, 4 R-regs, 2 H-regs.
# End of program
