...
#var float4 main.tex_light : $vout.TEXCOORD3 : TEX3 : -1 : 1
#var float4 main.tex_deluxe : $vout.TEXCOORD4 : TEX4 : -1 : 1
...
PARAM s259[4] = { state.matrix.mvp };
	...
	DP4 result.texcoord[4].x, s279[0], v9;
	DP4 result.texcoord[4].y, s279[1], v9;
	DP4 result.texcoord[4].z, s279[2], v9;
	DP4 result.texcoord[4].w, s279[3], v9;
END
# 30 instructions
# 1 temp registers
# End of program
