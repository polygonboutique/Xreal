...
PARAM s259[4] = { state.matrix.mvp };
	...
	DP4 result.texcoord[2].x, s267[0], v8;
	DP4 result.texcoord[2].y, s267[1], v8;
	DP4 result.texcoord[2].z, s267[2], v8;
	DP4 result.texcoord[2].w, s267[3], v8;
	DP4 result.texcoord[3].x, s271[0], v0;
	DP4 result.texcoord[3].y, s271[1], v0;
	DP4 result.texcoord[3].z, s271[2], v0;
	DP4 result.texcoord[3].w, s271[3], v0;
	DP4 result.texcoord[4].x, s279[0], v0;
	DP4 result.texcoord[4].y, s279[1], v0;
	DP4 result.texcoord[4].z, s279[2], v0;
	DP4 result.texcoord[4].w, s279[3], v0;
END
# 24 instructions
# 0 temp registers
# End of program
