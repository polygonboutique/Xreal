...
void dxGeomTransform::computeAABB()
{
  ...
  // compute the AABB
  obj->computeAABB();
  memcpy (aabb,obj->aabb,6*sizeof(vec_t));
...
{
	dMULTIPLY0_331(final_pos, (vec_t*)R, obj->pos);
	
	final_pos[0] += pos[0];
	final_pos[1] += pos[1];
	final_pos[2] += pos[2];
	
	dMULTIPLY0_333((vec_t*)final_R, (vec_t*)R, (vec_t*)*obj->R);
}
		       ...
		       dContactGeom *contact, int skip)
{
  ...
  vec_t *posbak = tr->obj->pos;
  matrix_c *Rbak = tr->obj->R;
