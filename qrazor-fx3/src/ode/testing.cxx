...
#ifdef dDOUBLE
static const vec_t tol = 1.0e-9;
#else
static const vec_t tol = 1.0e-5f;
#endif
...
vec_t dMatrixComparison::nextMatrix (vec_t *A, int n, int m, int lower_tri,
				     char *name, ...)
{
  ...
  if (afterfirst==0) {
    ...
    mi->n = n;
    mi->m = m;
    mi->size = num * sizeof(vec_t);
    mi->data = (vec_t*) dAlloc (mi->size);
