...
void dMultidot2 (const vec_t *a0, const vec_t *a1,
		 const vec_t *b, vec_t *outsum, int n);
*/
 ...
 * d.
 */
void dFactorLDLT (vec_t *A, vec_t *d, int n, int nskip);
 ...
 */
void dSolveL1 (const vec_t *L, vec_t *b, int n, int nskip);
