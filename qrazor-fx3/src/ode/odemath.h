...
PURE_INLINE vec_t dDOT   (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,1,1); }
PURE_INLINE vec_t dDOT13 (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,1,3); }
PURE_INLINE vec_t dDOT31 (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,3,1); }
PURE_INLINE vec_t dDOT33 (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,3,3); }
PURE_INLINE vec_t dDOT14 (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,1,4); }
PURE_INLINE vec_t dDOT41 (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,4,1); }
PURE_INLINE vec_t dDOT44 (const vec_t *a, const vec_t *b) { return dDOTpq(a,b,4,4); }
 ...
 */
inline vec_t	dDISTANCE(const float a[3], const float b[3])
{
	return (vec_t)X_sqrt((a[0]-b[0])*(a[0]-b[0]) + (a[1]-b[1])*(a[1]-b[1]) + (a[2]-b[2])*(a[2]-b[2]));
}
