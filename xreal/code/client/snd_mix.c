  ...
  if (com_altivec->integer)
    {
      ...
      S_PaintChannelFrom16_altivec (ch, sc, count, sampleOffset,
				    bufferOffset);
      return;
    }
#endif
...
static void
S_PaintChannelFromWavelet (channel_t * ch, const sfx_t * sc, int count,
			   int sampleOffset, int bufferOffset)
{
  int data;
  int leftvol, rightvol;
...
static void
S_PaintChannelFromADPCM (channel_t * ch, const sfx_t * sc, int count,
			 int sampleOffset, int bufferOffset)
{
  int data;
  int leftvol, rightvol;
...
static void
S_PaintChannelFromMuLaw (channel_t * ch, const sfx_t * sc, int count,
			 int sampleOffset, int bufferOffset)
{
  int data;
  int leftvol, rightvol;
