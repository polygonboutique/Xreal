...
//	int			 i;
	...
	if ( level.time - ent->timestamp > (FLAME_LIFETIME-350) ) { // JPW NERVE increased to 350 from 250 to match visuals better
		G_FreeEntity( ent );
		return;
	}
	/*
