...
void UpdateTournamentInfo(void)
{
	...
	else
	{
		...
		Com_sprintf(msg, sizeof(msg), "postgame %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i", level.numNonSpectatorClients,
					...
					player->client->ps.persistant[PERS_TELEFRAG_FRAG_COUNT], player->client->ps.persistant[PERS_SCORE],
		...
		Com_sprintf(msg, sizeof(msg), "postgame %i %i %i %i %i %i %i %i %i", level.numNonSpectatorClients, playerClientNum, accuracy,
					...
					player->client->ps.persistant[PERS_GAUNTLET_FRAG_COUNT], player->client->ps.persistant[PERS_TELEFRAG_FRAG_COUNT],
