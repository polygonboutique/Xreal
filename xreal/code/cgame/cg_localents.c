...
====================
*/
void CG_AddShockWave(localEntity_t * le)
{
	refEntity_t    *re;
...
//          trap_S_StartSound (re->origin, ENTITYNUM_WORLD, CHAN_AUTO, cgs.media.kamikazeExplodeSound );
			trap_S_StartLocalSound(cgs.media.shockWaveExplodeSound, CHAN_AUTO);
...
//              trap_S_StartSound (re->origin, ENTITYNUM_WORLD, CHAN_AUTO, cgs.media.kamikazeImplodeSound );
				trap_S_StartLocalSound(cgs.media.shockWaveImplodeSound, CHAN_AUTO);
