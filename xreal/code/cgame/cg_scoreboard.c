...
static void CG_DrawClientScore(int y, score_t * score, float *color, float fade, qboolean largeFormat)
{
	...
	if(score->ref != 0)
	{
		CH_DrawStringExt(50, y, "^f^1REF^F^0REF^n", BIGCHAR_WIDTH, BIGCHAR_HEIGHT, colorWhite, 0, qfalse);
	}
	...
	CH_DrawStringExt(SB_SCORELINE_XB + (SB_RATING_WIDTH / 2) + 20, y + 2, string, TINYCHAR_WIDTH + 3, TINYCHAR_HEIGHT + 3,
					 colorWhite, 27, qfalse);

	CH_DrawStringExt(SB_NAME_XB + 400, y + 2, string2, TINYCHAR_WIDTH + 3, TINYCHAR_HEIGHT + 3, colorWhite, 27, qfalse);
...
//  qboolean haveflag = qfalse;
	...
	CH_DrawStringExt(220, y + 2, string, TINYCHAR_WIDTH + 3, TINYCHAR_HEIGHT + 3, colorWhite, 27, qfalse);
...
//      s = va("Fragged by %s", cg.killerName );
		Com_sprintf(s, sizeof(s), "Fragged by %s", cg.killerName);
		w = CG_DrawStrlen(s) * BIGCHAR_WIDTH;
		x = (SCREEN_WIDTH - w) / 2;
		y = 40 + 50;
		CG_DrawBigString(x, y, s, fade);
//  CH_DrawStringExt( x, 90,s,BIGCHAR_WIDTH, BIGCHAR_HEIGHT, colorWhite, 900, qfalse);
