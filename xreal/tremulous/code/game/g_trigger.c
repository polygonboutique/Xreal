...
void trigger_ammo_touch(gentity_t * self, gentity_t * other, trace_t * trace)
{
	...
	BG_UnpackAmmoArray(other->client->ps.weapon, other->client->ps.ammo, other->client->ps.powerups, &ammo, &clips);
	...
	BG_PackAmmoArray(other->client->ps.weapon, other->client->ps.ammo, other->client->ps.powerups, ammo, clips);
}
