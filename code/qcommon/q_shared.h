...
// XreaL matrix math functions required by the renderer
...
// Tr3B: if you increase GMODELNUM_BITS then increase MAX_CONFIGSTRINGS to 2048 and double MAX_MSGLEN
...
// bit field limits
// Tr3B: NOTE: never go beyond 32 without recoding the delta compression of playerState_t in msg.c
#define MAX_STATS 16
