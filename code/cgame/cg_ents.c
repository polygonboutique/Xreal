...
/*
	...
	if (weapon->projectileLight) {
		trap_R_AddLightToScene(cent->lerpOrigin, weapon->projectileLight, weapon->projectileLightColor[col][0], weapon->projectileLightColor[col][1], weapon->projectileLightColor[col][2]);
	}
*/
	// add dynamic light
	if (weapon->projectileLight) {
		trap_R_AddLightToScene(cent->lerpOrigin, weapon->projectileLight, weapon->projectileLightColor[0], weapon->projectileLightColor[1], weapon->projectileLightColor[2]);
	}
	// add missile sound
...
*/
	...
	if (weapon->projectileLight2) {
		trap_R_AddLightToScene(cent->lerpOrigin, weapon->projectileLight, weapon->projectileLightColor2[0], weapon->projectileLightColor2[1], weapon->projectileLightColor2[2]);
	}
	// add missile sound
